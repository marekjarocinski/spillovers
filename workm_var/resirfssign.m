function [irfs_draws, isuccess] = resirfssign(res, nstep, dims_array, test_restr, b_normalize, max_attempts)
...
%   isuccess - indicator of draws for wich a rotation was successully found
%
% DEPENDS: -
...
for i = 1:ndraws
    ...
    if i == 20
        ...
        progress_report = total_time_in_minutes > 3; % if more than 3 min.
    end
    % progress report
